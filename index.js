...
global.botname = "𝐊𝐈𝐍𝐆-𝐒𝐀𝐍𝐃𝐄𝐒𝐇-𝐌𝐃💤"
global.themeemoji = "💙"
    ...
    XeonBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            await XeonBotInc.sendMessage(botNumber, { 
                text: `🤖 KING-SANDESH-MD Connected Successfully!\n\n⏰ Time: ${new Date().toLocaleString()}\n✅ Status: Online and Ready!
            ...
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: MR UNKNOWN`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} TIK TOK: @mr__unknown_sandesh`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: MR SANDESH BHASHANA`))
            console.log(chalk.green(`${global.themeemoji || '•'} 🤖 KING-SANDESH-MD Connected Successfully! ✅`))
        }
        if (
            connection === "close" &&
            lastDisconnect &&
