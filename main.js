...
require('./KingSandesh1.js')
nocache('../KingSandesh1.js', module => console.log(color('[ CHANGE ]', 'green'), color(`'${module}'`, 'green'), 'Updated'))
require('./main.js')
...
try{
		...
		if (update.connection == "open" || update.receivedPendingNotifications == "true") {
	        ...
	        console.log(color(`\n${themeemoji} YT CHANNEL: Mr Unknown`,'magenta'))
            console.log(color(`${themeemoji} GITHUB: SANDESH-MD `,'magenta'))
            console.log(color(`${themeemoji} TIKTOK: @mr_unknown_sandesh `,'magenta'))
